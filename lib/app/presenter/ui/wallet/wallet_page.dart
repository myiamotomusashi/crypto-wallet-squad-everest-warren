              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    IconButton(
                      onPressed: () => ref
                          .read(visibilityProvider.state)
                          .state = !ref.read(visibilityProvider.state).state,
                      icon: const Icon(
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  Visibility(
                                    ...
                                    visible: ref
                                        .watch(visibilityProvider.state)
                                        .state,
                                    child: Text(
